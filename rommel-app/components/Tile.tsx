...
export default function Tile(props: TileInterface) {
  ...
  return (
    <div className="flex items-start justify-center p-3 my-20 md:w-1/3 md:p-5">
      <div className="relative flex flex-wrap max-w-380">
        <Image src={props.image} alt={props['image-alt']} />
        <div className="absolute top-0 right-0 p-3 py-3 mt-10 font-semibold bg-white">{props.type} {getDate(props.date)}</div>
